...
export function StatCard({
  ...
  return (
    <div className={cn("bg-white rounded-xl border border-slate-200 p-5 transition-all flex flex-col justify-between h-full", className)}>
        ...
        <div className="flex items-center flex-wrap gap-2.5 mb-1.5">
          ...
          {trend && (
            <div className={cn("text-[11px] font-bold px-2 py-0.5 rounded-md inline-flex items-center h-fit", {
              'bg-[var(--brand-wash)] text-[var(--brand)]': trendDirection === 'up',
